...
if __name__ == "__main__":
    ...
    parser.add_argument("--method", type=str, default='VM', choices=['VM', 'Mr', 'VM-Un', 'Mr-Un', 'VM-diff', 'Mr-diff', 'VM-Un-diff', 'Mr-Un-diff', 'VM-Al-Un', 'VM-SFA', 'VM-SFA-diff', 'VM-SFAeach', 'VM-SFAeach-diff', 'Mr-SFAeach', 'Mr-SFAeach-diff'])
